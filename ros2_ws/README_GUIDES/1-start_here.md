...
Included in this tutorial is a sample ROS program. Once you are finished, you can replace the sample program with your own and get right to testing.
...
Anything you will launch should be from the ros2_ws. It simplifies everything. If you change up the flow then you might throw yourself into a dependency hell and be stuck crawling through nested launch and config files. Don't reinvent the wheel, just use the tool as is.

All your code will be in workbench. It's isolated, safe, clean and organized. Use whatever structure you want in there, that's your room to do what you want with. Right now it holds only the example program.